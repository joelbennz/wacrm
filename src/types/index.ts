...
export interface Contact {
  ...
  email?: string | null;
  company?: string | null;
  /** FK to `companies.id` — the linked company record, if any. Prefer
   *  this (with `company_record` hydrated) over the free-text
   *  `company` field when both are present. */
  company_id?: string | null;
  /** Hydrated by queries that embed `companies(*)`. Absent otherwise. */
  company_record?: Company | null;
  avatar_url?: string | null;
  /** Engagement metrics maintained from conversation messages (037/038). */
  ...
  tags?: Tag[];
  /** Source operations linked to this central contact identity. */
...
export type ContactIngestionMethod = 'manual' | 'csv' | 'api' | 'event';
...
export interface ContactOperation {
  ...
  ingestion_method: ContactIngestionMethod;
